...
const confluence_1 = require("./remark/confluence");
...
class ConfluencePod extends pods_core_1.PublishPod {
    ...
    plant(opts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            iConfig.hierarchyDisplay = false;
            iConfig.preview.enableFMTitle = false;
            const proc = engine_server_1.MDUtilsV5.procRehypeFull({
                engine,
                fname: note.fname,
                vault: note.vault,
            }, { flavor: engine_server_1.ProcFlavor.REGULAR });
            proc.use(confluence_1.confluence);
            const content = yield proc.process(common_all_1.NoteUtils.serialize(note));
            ...
            this.extractAttachments(contentString).forEach((attachment) => __awaiter(this, void 0, void 0, function* () {
